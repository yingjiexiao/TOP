# the script to construct TOP model, test TOP model, obtain the optimal weights and select similar individuals for a given target
# Notes:
# N: pool sizes
# res_M: the trait predictions of training set  
# Tres_M: the trait predictions of testing set  
# dis: the real phenotypes of training set 
# Tdis: the real phenotypes of testing set
# w: the optimal weights
# Tres_M0: the normalized trait predictions of testing set   
# Tdis0: the normalized real phenotypes of testing set
# n: pool size
...
wres<-function(res_M,Tres_M,dis,Tdis,N,m){
...
model=list(w=(-w),MC=MC)
return(model)
}
###############################################################Learn optimal weights
T_wres<-function(res_M,dis){
